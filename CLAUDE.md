...
- `--json` flag on compile/validate/estimate/diff/formal for CI/scripting integration
...
- 44 Rust unit tests + 19 integration tests, 13+ cocotb simulation tests, 85%+ functional coverage
...
cargo test                                       # 63 tests (44 unit + 19 integration)
```
...
- `src/main.rs` — clap CLI (compile, validate, init, estimate, diff, graph, stats, formal)

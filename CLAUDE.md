...
- 602 Rust unit tests + 389 integration tests = 991 total, 90 Python scoreboard tests, 13+ cocotb simulation tests, 5 conntrack cocotb tests, 85%+ functional coverage
...
- `src/main.rs` — clap CLI (37 subcommands)
